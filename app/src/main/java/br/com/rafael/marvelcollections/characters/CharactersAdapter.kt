...
class CharactersAdapter constructor(private val imageLoader: ImageLoader) : RecyclerView.Adapter<CharactersAdapter.CharacterCellViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CharacterCellViewHolder, position: Int) {
        ...
        holder.bind(character, imageLoader)
    }
    ...
    class CharacterCellViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(character: Character, imageLoader: ImageLoader) = with(itemView) {
